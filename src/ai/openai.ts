  ...
  constructor(config: AiProviderConfig) {
    ...
    if (isOpenRouter) {
      ...
      clientOptions.defaultHeaders = {
        'HTTP-Referer': 'https://github.com/ycherry/cy-ai-code-review',
        'X-Title': 'CY Code Review',
      }
      ...
      if (config.model.includes('/')) {
        clientOptions.defaultHeaders['HTTP-Referer'] = `https://github.com/ycherry/cy-ai-code-review (${config.model})`
      }
    }
